...
<section class="content-header shadow-title">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 title-color">Términos y condiciones</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div style="padding: 0rem 2rem 1rem 2rem;">
            <div style="padding: 2rem; text-align: justify;">
                ...
                <p>
                    A los Usuarios, les informamos que los siguientes Términos y Condiciones les son aplicables por el simple uso o acceso a cualquiera de las páginas, aplicaciones web y móviles, softwares y, aplicaciones en general, que integran el Portal de <a href="https://www.reachmx.com">www.reachmx.com</a> (en adelante y, conjunta e indistintamente, el "Portal"), por lo que entenderemos que los acepta y acuerda en obligarse a su cumplimiento. <strong>En el caso de que no esté de acuerdo con los Términos y Condiciones deberá abstenerse de acceder o utilizar el Portal.</strong>
                    <br><br>
                    Reachmx Trade Solutions SAPI de CV y/o sus subsidiarias, controladoras, partes relacionadas y afiliadas (en adelante y, conjunta e indistintamente, la “Empresa”) se reservan el derecho de modificar discrecionalmente el contenido del Portal en cualquier momento, sin necesidad de previo aviso.
                    <br><br>
                ...
                <h5 class="title-color">1. USO Y RESTRICCIONES.</h5>
                <p>
                ...
                <h5 class="title-color">3. PROPIEAD INTELECTUAL.</h5>
                <p>
                    Los derechos de propiedad intelectual, propiedad industrial respecto de los Servicios y Contenidos, los signos distintivos y dominios de las Páginas o del Portal, así como los derechos de uso y explotación de estos, incluyendo de manera enunciativa más no limitativa, su divulgación, publicación, reproducción, distribución y transformación, son propiedad exclusiva de la Empresa. El Usuario no adquiere ningún derecho de propiedad intelectual y/o industrial por el simple uso o acceso de los Servicios y Contenidos del Portal y, en ningún momento, dicho uso será considerado como una autorización o licencia para utilizar los Servicios y Contenidos con fines distintos a los que se contemplan en los presentes Términos y Condiciones.
                </p>
                <h5 class="title-color">4. PROPIEDAD INTELECTUAL DE TERCEROS</h5>
                <p>
                ...
                <h5 class="title-color">5. CALIDAD DE LOS SERVICIOS Y CONTENIDOS Y SUS GARANTÍAS.</h5>
                <p>
                    ...
                    <p style="margin-left: 4rem;">
                        <strong>5.1 DEVOLUCIONES Y CANCELACIONES.</strong> Para seguridad de los Usuarios, en cualquier momento podrán cancelar los Servicios y Contenidos que adquieran en el Portal, a su entera discreción y sin responsabilidad alguna.
                    </p>
                    <p style="margin-left: 4rem;">
                        <strong>5.2 ENVÍOS.</strong> La Empresa no será responsable de ninguna demora y/o incumplimiento respecto de los envíos realizados ni mediante terceros ajenos a la Empresa, el Usuario acepta los riesgos adjuntos y se sujeta a los Términos y Condiciones del proveedor de servicios encargado del envío.
                    </p>
                </p>
                <h5 class="title-color">6. BIENES Y SERVICIOS DE TERCEROS ENLAZADOS.</h5>
                <p>
                ...
                <h5 class="title-color">7. CONFIDENCIALIDAD</h5>
                <p>
                ...
                <h5 class="title-color">8. USO DE LA INFORMACIÓN NO CONFIDENCIAL.</h5>
                <p>
                ...
                <h5 class="title-color">9. COOKIES</h5>
                <p>
                ...
                <h5 class="title-color">10. AVISO DE PRIVACIDAD DE DATOS PERSONALES.</h5>
                <p>
                    Toda la información que la Empresa recabe del Usuario es tratada con absoluta confidencialidad conforme las disposiciones legales aplicables en la legislación mexicana.
                    <br><br>
                    Para conocer más sobre la protección de sus datos personales por favor consulte nuestro Aviso de Privacidad.
                </p>
                <h5 class="title-color">11. CLAVES DE ACCESO.</h5>
                <p>
                ...
                <h5 class="title-color">12. MODIFICACIONES</h5>
                <p>
                ...
                <h5 class="title-color">13. LEYES APLICABLES Y JURISDICCIÓN.</h5>
                <p>
                ...
                <h5 class="title-color">14. CONTACTO.</h5>
                <p>
                    El Usuario puede contactar, en todo momento, al personal de la Empresa para cualquier aclaración, comentario, duda y/o sugerencia relacionada con los Servicios y Contenidos, con el Portal y/o con los presentes Términos y Condiciones en legal@reachmx.com.
                </p>
            </div>
        </div>