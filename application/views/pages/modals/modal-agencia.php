...
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" id="agregar_agencia">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
                                <select class="form-control-sm styleselectladas boder-lad" id="sel_Lada">
                                ...
                                <span class="input-group-text span-lada" id="spLada"></span>
                            </div>
                            <input type="text" class="form-control form-control-sm inp-phone" id="txt_telefono" value="" maxlength="14">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <hr>
                <h5 class="modal-title text-uppercase title-color" id="modalDetalle">Puerto</h5>
                <hr>
                <div class="form-group row">
                    <div class="col-md-6">
                        <label>Puerto</label>
                       <input type="text" class="form-control form-control-sm borders" id="txt_transporte_aa" required>
                    </div>
                    <div class="col-md-6">
                        <label>Clave</label>
                        <input type="text" class="form-control form-control-sm borders" id="txt_clave_aa" required>
                    </div>
                </div>
        </div>
