...
if ($Data_detalle_proveedor != FALSE) {
    foreach ($Data_detalle_proveedor->result() as $row) {
        $id_proveedor = $row->id_proveedor_c;
...
<div class="col-12 ml-auto text-right" style="margin-top: 3.2px;">
    <button type="button" id="btnNuevoProd" class="btn btn-sm btn-outline-primary btn-nuevo add_producto" data-id="<?= $row->id_proveedor_c; ?>">
                    ...
                    <div class="card-body" style="padding-bottom: 0rem;">
                        <div class="row">
                            ...
                            <div class="col-2 ml-auto text-right margin-edit">
                                <a href="" class="editProveedor" type="button" data-id="<?= $row->id_proveedor_c ?>">
                    ...
                    <div class="card-body">
                        <table id="tblProductosProv" class="table table-borderless responsive nowrap" style="width: 100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr class="shadow border-row" id="tr_<?= $row->id_producto_c; ?>" name="tr_<?= $row->id_producto_c; ?>">
                                            ...
                                            <td style="vertical-align: middle; text-align: center">
                                                <a type="button" href="" data-id="<?= $row->id_producto_c; ?>" class="edit_producto" title="Modificar producto" data-toggle="tooltip" data-placement="top">
                                                    <i class="far fa-edit"></i>
                                                </a>
                                                <?php
                                                if ($level <= 2) {
                                                ?>
                                                    <!-- <a type="button" href="" data-id="<?= $row->id_producto_c; ?>" class="eliminar_producto" style="color: #dc3545;" title="Eliminar producto" data-toggle="tooltip" data-placement="top">
