        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-6 dash-margins">
                <div class="small-box bg-success">
                    ...
                    <a href="<?= base_url() ?>Plataforma/agencias_aduanales" class="small-box-footer">Mas información <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-2 col-6 dash-margins">
                <div class="small-box bg-primary">
                    ...
                    <a href="<?= base_url() ?>Plataforma/Proveedores" class="small-box-footer">Mas información <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-2 col-6 dash-margins">
                <div class="small-box bg-success">
                    ...
                    <a href="<?= base_url() ?>Plataforma/vista_clientes" class="small-box-footer">Mas información <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="row">
                                ...
                                <ul class="products-list product-list-in-card pl-2 pr-2">
                                    <?php if ($Data_UltCotizaciones != FALSE) {
                                        foreach ($Data_UltCotizaciones->result() as $row) {
                                            ...
                                            <li class="item">
                                                <div>
                                                    <a href="<?= base_url("Plataforma/DetalleProyectos/$id_proyecto") ?>" class="product-title">
                                                        <?= $nombreCot ?>
                    ...
                    <div class="col-md-8 dash-margins">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <canvas id="donutAdmin" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 575px;" width="575" height="250" class="chartjs-render-monitor"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 dash-margins" style="padding: 0;display: none;">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title" style="margin-bottom: 0;"><i class="fas fa-cubes"></i>Ultimos productos</h3>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                        <i class="fas fa-minus"></i>
                                    </button>
                                            ...
                                            <li class="item">
                                                <div>
                                                    <a href="" class="product-title">
                                                        <?= $Nombre ?>
                                                        <span class="badge badge-light float-right">Precio: $<?= $precioFormat ?></span>
                                                    </a>
                                        ...
                                        foreach ($Data_UltProyectos->result() as $row) {
                                            ...
                                            <li class="item">
                                                <div>
                                                    <a href="" class="product-title">
                                                        <?= $aRegistro ?>-<?= $folio ?>
                                                        <span class="badge badge-light float-right"><?= $fechaCreacion ?></span>
                                                    </a>
                                        ...
                                        <?php if ($Data_SourcingProy != FALSE) {
                                            foreach ($Data_SourcingProy->result() as $row) {
                                                ...
                                                <tr class="shadow border-row" id="tr_<?= $row->id_proyecto; ?>" style="vertical-align: middle">
                                                    ...
                                                    <td style="vertical-align: middle"><span><?= $row->Asesor; ?></span></td>
