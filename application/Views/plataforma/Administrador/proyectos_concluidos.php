...
<section class="content-header shadow-title">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 title-color">Proyectos concluidos</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Proyectos concluidos</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="container-fluid">
        ...
        <div style="padding-bottom: 1rem;">
            <table id="tblProyConclAdmin" class="table table-borderless responsive nowrap" style="width: 100%">
                <thead>
                    <tr>
                        <th>#Folio</th>
                        <th>Estatus</th>
                ...
                <tbody> 
                  <?php if ($DATA_TODOSPROYECTOS != FALSE) {
                ...
                $ETA = date('d-m-Y', strtotime($row->eta)); ?>
                    ...
                    <tr class="shadow border-row" id="tr_<?= $row->id_proyecto; ?>" name="tr_<?= $row->id_proyecto; ?>">
                        <td style="vertical-align: middle">
                            <a id="btnDetallePy" href="<?= base_url("Plataforma/DetalleProyectos/$id_proyecto") ?>"
        ...
        <div class="modal fade" id="modal_editar_proyeco" tabindex="-1" role="dialog"
            aria-labelledby="asignar_asesorModalLabel" aria-hidden="true">
