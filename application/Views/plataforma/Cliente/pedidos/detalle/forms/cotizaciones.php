                ...
                foreach ($Data_Cotizacion->result() as $row) {
                    ...
                    if ($activo > 1 && $activo < 5) { ?>
                        <ul class="list-group liCotizacion" id="liCotizacion" data-id="<?= $IdCotizacion ?>">
                            <li class="list-group-item d-flex justify-content-between align-items-center list-cot" style="margin-bottom: 1rem;">
                                ...
                                <?php } else if ($activo == 4) { ?>
                                    <span class="badge badge-warning badge-pill">Solicitada a recotizar</span>
                                <?php } ?>
                            </li>
                        </ul>
                        <ul class="list-group list-none liDetCotizacion" id="liDetCotizacion<?= $IdCotizacion ?>" style="display: none;">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center list-cot-det" style="padding: 1rem 1.5rem 0.5rem 1.5rem !important;">
                                <?php
                                    if ($data_get_pdfCotizacion != FALSE) {
                                        $id_documento = $data_get_pdfCotizacion->id_documento;
                                ?>
                                    <span><a href="" id="btnDescargarCotizacion" download data-id="<?= $id_documento; ?>" ><i class="fas fa-file-download"></i></a></span>
                                <?php
                                    }
                                ?>
                                <span class="list-Content m-0 text-left">
