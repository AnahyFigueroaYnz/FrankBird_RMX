...
?>
<link rel="stylesheet" href="<?= base_url() ?>css/cliente/pedidos.css ">
<section class="content-header shadow-title">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 title-color">Lista pedidos</h1>
            </div>
            <div class="col-sm-6">
...
<section class="content">
    <div class="container-fluid">
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 ml-auto text-center" style="margin-top: 1rem;">
            <a type="button" href="<?= base_url() ?>Clientes/NuevoPedido" id="btnNuevoPedido"
                class="btn btn-sm btn-outline-primary btn-nuevo">
                Nuevo pedido <span><i class="fas fa-plus"></i></span>
            </a>
        </div>
        <br>
        <div style="padding-bottom: 1rem;">
            <table id="tblPedidos" class="table table-borderless responsive nowrap" style="width: 100%">
                <thead>
                    <tr>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Es el identificacdr o numero del pedido">#Folio</a></th>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Nombre asignado por el asesor al pedido">Nombre Proyecto</a></th>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Estatus del pedido segun el avance de este">Estatus</a></th>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Fecha en la que se realizó el pedido">Fecha Orden</a></th>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Fecha donde los productos del pedido se encuentran en camino">Fecha
                                Salida</a></th>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Fecha donde los productos del pedido han llegado a su destino">Fecha
                                Llegada</a></th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
          if ($data_mis_pedidos != FALSE) {
            foreach ($data_mis_pedidos->result() as $row) {
