                ...
                <thead>
                    <tr>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Es el identificacdr o numero de la cotizacion">#Folio</a></th>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Nombre de la cotización asignada por el asesor">Cotizacion</a></th>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Es el identificacdr o numero del pedido">#Pedido</a></th>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
                                data-content="Total monetario de la cotización">Total</a></th>
                        <th><a class="mr-auto" style="cursor: help;" data-toggle="popover" data-trigger="hover"
          ...
          ?>
                    <tr class="shadow border-row">
                        <td style="vertical-align: middle">
                            <a href="<?= base_url(); ?>Clientes/DetalleCotizacion/<?= $row->id_cotizacion ?>"
