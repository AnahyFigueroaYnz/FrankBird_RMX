    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12 text-center">
                <h1 class="m-0 letra">Bienvenido <?= $nombre ?></h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-4 col-12 dash-margins">
                <div class="small-box bg-primary">
                    ...
                    <a href="<?= base_url() ?>Plataforma/MisProyectos" class="small-box-footer">Mas información <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-12 dash-margins">
                <div class="small-box bg-success">
                    ...
                    <a href="<?= base_url() ?>Plataforma/MisProyectosActivos" class="small-box-footer">Mas información <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-12 dash-margins">
                <div class="small-box bg-primary">
                    ...
                    <a href="<?= base_url() ?>Plataforma/MisProyectosConcluidos" class="small-box-footer">Mas información <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="col-md-8 dash-margins">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <canvas id="donutAsesor" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 575px;" width="575" height="250" class="chartjs-render-monitor"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
