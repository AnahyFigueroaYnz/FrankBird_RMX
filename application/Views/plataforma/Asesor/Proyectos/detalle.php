...
<section class="content">
  <div class="container-fluid">
    <div>
      ...
      <div style="width: 100%">
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="tab-pane fade" id="nav-CalculoCostos" role="tabpanel" aria-labelledby="nav-CalculoCostos-tab">
            <div class="row">
              <div class="col-lg-7 col-md-7 col-12 card-right">
                <div class="card shadow-cards tarjeta">
                  <div class="card tarjeta-form" style="border-bottom: transparent;">
    ...
    <div class="modal fade" id="modalBL" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
      <?php $this->load->view('plataforma/asesor/proyectos/modals/modal-bl'); ?>
    </div>

    <div class="modal fade" id="modalDone" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
