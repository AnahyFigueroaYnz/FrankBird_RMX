...
class Clientes extends CI_Controller
{
	...
	/**  Función inicial, cargar navBar: Administrador, Asesor y Cliente */
		...
		if ($this->mantenimiento() == FALSE) {
			if ($this->seguridad() == TRUE) {
				...
				$data = array(
					...
					'Data_Proyectos' => $this->Clientes_model->noMyProyectos($id_usuario),
					'Data_Activos' => $this->Clientes_model->noProyActivos($id_usuario),
					'Data_Cancluidos' => $this->Clientes_model->noProyConcluidos($id_usuario),
					'Data_UltCotizaciones' => $this->Clientes_model->lastMyCotizaciones($id_usuario),
					'Data_SourcingProy' => $this->Clientes_model->sourcingMisProy($id_usuario),
					'Data_Pendientes' => $this->Clientes_model->pendientesTasks($id_usuario),
				);
				$this->load->view('headers/header');
				$this->load->view('headers/navbar_clientes');
				$this->load->view('plataforma/cliente/dashboardCliente', $data);
	...
	// Vista para carga de pedidos: clientes 
	public function MisPedidos()
	{
		if ($this->mantenimiento() == FALSE) {
			if ($this->seguridad() == TRUE) {
				...
				$activo = 1;
				$data = array(
					'data_mis_pedidos' => $this->Clientes_model->get_mis_pedidos($id_cliente, $activo),
					'data_unidades' => $this->Clientes_model->get_unidades(),
					'DATA_LADAS' => $this->Clientes_model->get_ladas(),
				);
				$this->load->view('headers/header');
				$this->load->view('headers/navbar_clientes');
				$this->load->view('plataforma/cliente/pedidos/mis_pedidos', $data);
				$this->load->view('footers/footer_cierre');
				$this->load->view('footers/footer-script');
				$this->load->view('footers/cargar_js');
			} else {
	...
	// Vista para carga de pedidos: clientes  activo 2 status 24
	public function PedidosConcluidos()
	{
		if ($this->mantenimiento() == FALSE) {
			if ($this->seguridad() == TRUE) {
				$id_cliente = $this->session->userdata('id_usuario');
				$data = array(
					'data_mis_pedidos' => $this->Clientes_model->get_concluidos($id_cliente),
					'data_unidades' => $this->Clientes_model->get_unidades(),
					'DATA_LADAS' => $this->Clientes_model->get_ladas(),
				);
				$this->load->view('headers/header');
				$this->load->view('headers/navbar_clientes');
				$this->load->view('plataforma/cliente/pedidos/pedidos_concluidos', $data);
				$this->load->view('footers/footer_cierre');
				$this->load->view('footers/footer-script');
				$this->load->view('footers/cargar_js');
			} else {
	...
	public function PedidosActivos()
	{
		if ($this->mantenimiento() == FALSE) {
			if ($this->seguridad() == TRUE) {
				$id_cliente = $this->session->userdata('id_usuario');
				$data = array(
					'data_activos' => $this->Clientes_model->get_activos($id_cliente),
					'data_unidades' => $this->Clientes_model->get_unidades(),
					'DATA_LADAS' => $this->Clientes_model->get_ladas(),
				);
				$this->load->view('headers/header');
				$this->load->view('headers/navbar_clientes');
				$this->load->view('plataforma/cliente/pedidos/pedidos_activos', $data);
				$this->load->view('footers/footer_cierre');
				$this->load->view('footers/footer-script');
				$this->load->view('footers/cargar_js');
			} else {
	...
	// VISTA PROVEEDORES CLIENTES 
	public function MisProveedores()
	{
		if ($this->mantenimiento() == FALSE) {
			if ($this->seguridad() == TRUE) {
				$id_cliente = $this->session->userdata('id_usuario');
				$data2 = array(
					'proveedores_data' => $this->Clientes_model->ver_proveedores_clientes($id_cliente),
				);

				$this->load->view('headers/header');
				$this->load->view('headers/navbar_clientes');
				$this->load->view('plataforma/cliente/proveedores/proveedores', $data2);
				$this->load->view('footers/footer_cierre');
				$this->load->view('footers/footer-script');
			} else {
				redirect(base_url() . 'Home/Ingresar');
	...
	// VISTA PROVEEDOR CON PRODUCTOS CLIENTES 
	public function DetalleProveedor()
	{
		if ($this->mantenimiento() == FALSE) {
			if ($this->seguridad() == TRUE) {
				$id_proveedor_c = $this->uri->segment(3);
				$data2 = array(
					'proveedores_detalle' => $this->Clientes_model->detalle_proveedores_clientes($id_proveedor_c),
					'productos_cliente_prov' => $this->Clientes_model->get_productos_prov($id_proveedor_c),
				);
				$this->load->view('headers/header');
				$this->load->view('headers/navbar_clientes');
				$this->load->view('plataforma/cliente/proveedores/detalle_proveedor', $data2);
				$this->load->view('footers/footer_cierre');
				$this->load->view('footers/footer-script');
			} else {
				redirect(base_url() . 'Home/Ingresar');
	...
	// funcion para cargar la vista de los proyectos del cliente
	public function MisProductos()
	{
		if ($this->mantenimiento() == FALSE) {
			if ($this->seguridad() == TRUE) {
				$id_cliente = $this->session->userdata('id_usuario');
				$data = array(
					'data_producto_sp_cliente' => $this->Clientes_model->get_data_productos_sp($id_cliente),
				);
				$this->load->view('headers/header');
				$this->load->view('headers/navbar_clientes');
				$this->load->view('plataforma/cliente/productos/productos', $data);
				$this->load->view('footers/footer_cierre');
				$this->load->view('footers/footer-script');
			} else {
				redirect(base_url() . 'Home/Ingresar');
	...
	// funcion para cargar la vista de las cotzaciones
	public function MisCotizaciones()
	{
		if ($this->mantenimiento() == FALSE) {
			if ($this->seguridad() == TRUE) {
				$id_cliente = $this->session->userdata('id_usuario');
				$data = array(
					'get_cotizaciones' => $this->Clientes_model->get_cotizaciones($id_cliente),
				);

				$this->load->view('headers/header');
				$this->load->view('headers/navbar_clientes');
				$this->load->view('plataforma/cliente/cotizaciones/cotizaciones', $data);
				$this->load->view('footers/footer_cierre');
				$this->load->view('footers/footer-script');
			} else {
				redirect(base_url() . 'Home/Ingresar');
	...
	// funcion para cargar el detalle de la cotización
	public function DetalleCotizacion()
	{
		if ($this->mantenimiento() == FALSE) {
			if ($this->seguridad() == TRUE) {
				...
				$data = array(
					'data_cotizacion' => $this->Clientes_model->detalleCotizacion($id_cotizacion),
					'productos_cot' => $this->Clientes_model->productosCot($id_cotizacion),
					'medi_prod_cot' => $this->Clientes_model->mediProdCot($id_cotizacion),
					'prov_cliente' => $this->Clientes_model->provCliente($id_cotizacion),
				);
				// var_dump($data);
				$this->load->view('headers/header');
				$this->load->view('headers/navbar_clientes');
				$this->load->view('plataforma/cliente/cotizaciones/detalle_cotizacion', $data);
				$this->load->view('footers/footer_cierre');
				$this->load->view('footers/footer-script');
				$this->load->view('footers/cargar_js');
			} else {
		...
		if ($this->seguridad() == TRUE) {
			if ($this->input->is_ajax_request()) {
				...
				// insetrt arrays tasks
					// sourcing
						//Update a bitacora
							$tabla = "sourcing"; $tipo_accion = "Insert"; $id_name = "id_sourcing";
					...
					// production
						//Update a bitacora
							$tabla = "production"; $tipo_accion = "Insert"; $id_name = "id_production";
					...
					// freight
						//Update a bitacora
							$tabla = "freight"; $tipo_accion = "Insert"; $id_name = "id_freight";
					...
					// customs
						//update bitacora
							$tabla = "customs"; $tipo_accion = "Insert"; $id_name = "id_customs";
					...
					// quoted
						//
							$tabla = "quoted"; $tipo_accion = "Insert"; $id_name = "id_quoted";
					...
					// done
						//
							$tabla = "done"; $tipo_accion = "Insert"; $id_name = "id_done";
				...
				//foreach para el desglose de los datos de PROVEEDORES_CLIENTE, PRODUCTOS_CLIENTE Y PRODUCTOS_SP_CLIENTE
					foreach ($pedido as $pedido_individual) {
						...
						if ($pedido_individual["tipo_data"] == "proveedor_cliente") {
							...
							$data_producto_sp_cliente_controller = array(
								'id_cliente' => $data_proyecto_base["id_cliente"],
								'id_proyecto' => $id_proyecto_value,
								...
								'color_oem' => $pedido_individual["color_oem"],
								'img_path' => $pedido_individual["img_path"],
							);

							//insert para productos sin proveedor
							$this->Clientes_model->insert_productos_sp_clientes($data_producto_sp_cliente_controller);
	...
	{
		$id_consulta_last_tabla = $this->Clientes_model->last_tabla($tabla, $id_name);
		$id_tabla = $id_consulta_last_tabla->$id_name;
		//get last in bitacora 
		$id_consulta_bit = $this->Clientes_model->get_last_id_bit($tabla, $tipo_accion, $id_tabla);
		$id_bit = $id_consulta_bit->id_bit;
		$data_up = array('id_usuario' => $this->session->userdata('id_usuario'),);
		//Hace el update
		$this->Clientes_model->Update_bit($id_bit, $data_up);
	}
}
