                    ...
                    <ul class="list-group">
                        <?php if ($status < 5) {
                            if ($Data_Productos_C != FALSE) {
                                ...
                                $this->load->view('plataforma/cliente/pedidos/detalle/pasos_detalle/producto_cp');
                            }
                            if ($Data_Productos_SP_C != FALSE) {
                                $Prod_s_prov = 0;
                                foreach ($Data_Productos_SP_C as $row) {
                                ...
                                if ($Prod_s_prov >= 2) { ?>
                                    <p class="hr"></p>
                                <?php }
                                $this->load->view('plataforma/cliente/pedidos/detalle/pasos_detalle/producto_sp');
                            }
                        } else if ($status >= 5) {
                            $this->load->view('plataforma/cliente/pedidos/detalle/pasos_detalle/producto_cot');
                        } ?>
                    </ul>
                </div>
            </li>
