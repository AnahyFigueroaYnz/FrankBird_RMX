...
create table tipo_cambio(
	id_tipo_c int not null auto_increment primary key,
	tipo_cambio decimal(24,2),
	fecha_creacion date,
...
-- ESTRUCTURA TABLA RELACION ENTRE USUARIO Y AGENCIA
create table relacion_agente_aduanal(
	id_relacion_aa int not null auto_increment primary key,
	id_usuario int,
	id_agencia int,
...
-- ESTRUCTURA TABLA PROYECTO BASE
/*create table proyecto_base (
	id_proyecto_base int not null auto_increment primary key,
	a_registro int,
	folio int,
	id_cliente int,
	presupuesto decimal(24,2),
	preferencia_empaque varchar(60),
...
-- ESTRUCTURA TABLA PRODUCTOS CLIENTES SIN PROVEEDORES
create table productos_sp_clientes(
	id_producto_sp_c int not null auto_increment primary key,
	id_cliente int,
	id_proyecto int,
	producto_sp_c varchar(30),
	cantidad_sp_c int,
	id_unidad_md int,
	especificaciones_sp_c LONGTEXT,
	img_path longtext,
...
-- ESTRUCTURA TABLA COTIZADOR
create table destinos_cotizador (
	id_destino int not null auto_increment primary key,
	destino varchar(45),
	tipo int,
	activo int default 1
); -- 1 origen 2 destino 3 ambos

-- ESTRUCTURA TABLA CATALOGO (TARIFARIO)
create table catalogo_cotizador (
	id_catalogo int not null auto_increment primary key,
	id_origen int not null,
	id_destino int not null,
	tipo int,
	movimiento int default 1,
	tarifa_aerea decimal(24,2),
	lcl_cbm decimal(24,2),
	ft20 decimal(24,2),
	ft40 decimal(24,2),
	hq40 decimal(24,2),
	activo int default 1,
	foreign key (id_origen) references destinos_cotizador (id_destino),
	foreign key (id_destino) references destinos_cotizador (id_destino)
);
-- tipo 1 aereo 2 maritimo

-- ESTRUCTURA TABLA COTIZADOR
create table cotizador (
	id_cotizador int not null auto_increment primary key,
	id_catalogo int not null,
	folio varchar(45),
	email varchar(60),
	tipo_cambio decimal(24,2),
	tipo_solicitud varchar(45),
	tipo_envio varchar(45),
	tipo_contenedor varchar(45),
	contenedor varchar(45), -- tipo_capacidad
	cantidad_contenedor decimal(24,2), -- cant_tipo_capacidad
	volumen decimal(24,2),
	peso decimal(24,2),
	origen varchar(45),
	destino varchar(45),
	comentarios varchar(140),
	nombre_producto varchar(45),
	fracc_arancelaria int,
	valor_mercancia decimal(24,2), -- valor_mercancia
	despacho_aduanal decimal(24,2),
	previo_origen decimal(24,2),
	inspeccion_fabrica decimal(24,2),
	seguros_mercancia decimal(24,2),
	logistica decimal(24,2),
	honorario_rmx decimal(24,2),
	iva decimal(24,2),
	total decimal(24,2),
	fecha_creacion date,
	activo int default 1,
	foreign key (id_catalogo) references catalogo_cotizador (id_catalogo)
);